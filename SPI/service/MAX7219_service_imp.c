...
/* ---------------- ESCRITURA ---------------- */
// Escribe un dígito específico del display
...
void max7219_show_number_4digits(uint16_t number)
{
    ...
    max7219_write_digit(0x01, unidades);
    max7219_write_digit(0x02, decenas);
    max7219_write_digit(0x03, centenas);
    max7219_write_digit(0x04, miles);
}